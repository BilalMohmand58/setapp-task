export default function UserTestimonials() {
  ...
  return (
    <section className="w-full bg-white px-5 py-20 md:py-24">
      <div className="max-w-7xl mx-auto">
        {/* Section Header */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div>
            <h2 className="text-setapp-dark text-3xl md:text-4xl font-semibold tracking-wide mb-8">
              Setapp in your words.
            </h2>
          </div>
          <div>
            <p className="text-setapp-dark text-lg md:text-xl leading-relaxed">
              What you say about how Setapp powers you up.
            </p>
          </div>
          <div className="flex items-start justify-start lg:justify-end gap-2.5">
            {/* Social Icons */}
            <a
              href="#"
        ...
        <div className="flex justify-end gap-12 mb-8">
          <button className="text-setapp-dark opacity-60 hover:opacity-100 transition-opacity">
            <svg
              width="14"
              height="24"
              viewBox="0 0 14 24"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="rounded-[15px] bg-setapp-lightGray p-2 relative"
            >
              <div
                className="rounded-lg p-8 min-h-[290px] flex items-center"
              ...
              <div className="p-6 flex items-end justify-between">
                <div>
                  <p className="text-setapp-dark text-lg font-semibold">
                    {testimonial.author}
                  </p>
                  <p className="text-setapp-gray text-sm font-semibold">
                    {testimonial.handle}
                  </p>
                </div>
                <div className="text-[#1C95E0]">
